				...
				<div class="card h-100">
					...
					<div class="card-body p-4">
						<div class="text-center">
                            ...
                            <span class="badge badge-light fas fa-tie"><?= $ws['lokasi']?></span>
							<!-- Product price-->
						</div>
                        <br>
                        <b>
					...
					<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
						<div class="text-center">
							<a id="setdetail" class="btn btn-outline-dark btn text-dark mt-auto" 
                                ...
                                data-embed="<?= $ws['embed']?>"    
                            >Info</a>
							<a  id="pesanwisata" class="btn btn-outline-dark btn-light text-black mt-auto" 
                                data-toggle="modal"
								data-target="#pesan"
...
<div class="modal fade" id="pesan" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            <input type="submit" value="Pesan" class="btn btn-light">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
